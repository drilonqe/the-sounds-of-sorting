...
//https://stackoverflow.com/questions/8619948/why-cant-i-cast-int-to-t-but-can-cast-int-to-object-and-then-object-to-t/8619952#8619952
        ...
        while (i < n1 && j < n2) {
            ...
            if (L[i].compareTo(R[j]) <= 0) {
                // copy event
                event.add(new CopyEvent<Integer>(k, (Integer)(Object)L[i]));
                arr[k++] = L[i++];
            } else {
                // copy event
                event.add(new CopyEvent<Integer>(k, (Integer)(Object)R[j])); // tried doing just Integer it did not work
                arr[k++] = R[j++];
            }
        }
        ...
        while (j < n2) {
            event.add(new CopyEvent<Integer>(k, (Integer)(Object)R[j]));
            arr[k++] = R[j++];
        }
    }
